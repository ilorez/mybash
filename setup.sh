...
git clone https://github.com/ilorez/mybash "$LINUXTOOLBOXDIR/mybash"
if [ $? -eq 0 ]; then
...
installDepend() {
  ...
  DEPENDENCIES='bash bash-completion tar bat tree multitail fastfetch wget unzip fontconfig xclip'
